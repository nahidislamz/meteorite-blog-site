...
export const adminUserListView = config => {
    return dispatch => {
        ...
        AxiosInstance.get("/meteorite_admin/users/", config)
            .then(response => {
...
export const adminCreateUser = (data, config) => {
    return dispatch => {
        ...
        AxiosInstance.post("/meteorite_admin/users/", data, config)
            .then(response => {
...
export const adminViewAllPosts = config => {
    return dispatch => {
        ...
        AxiosInstance.get("/meteorite_admin/posts/", config)
            .then(response => {
...
export const adminEditUser = config => {
    return dispatch => {
        ...
        AxiosInstance.patch("/meteorite_admin/users/detail/", null, config)
            .then(response => {
